...
csv_file = open("normal_memoria_status.csv", "r", encoding="utf-8", errors="", newline="" )
f = csv.reader(csv_file, delimiter=",", doublequote=True, lineterminator="\r\n", quotechar='"', skipinitialspace=True)
csv_data = [row for row in f]


status_count = [0 for i in range(20)]
image_num = len(os.listdir("normal_memoria"))
target_count = 0
...
for int_memoria_no in range(1,image_num+1):
    ...
    input_memoria_img = cv2.imread("normal_memoria/"+memoria_no+".png")
